package javafxalvinhuang;
import javax.swing.JOptionPane;
import java.io.*;
import java.util.Random;


public class javafxfortuneteller {
...
Random random = new Random();//factor random for list
int randomfortune = random.nextInt(list.length);

		

String [] options = {"SEE MY FUTURE", "QUIT"};
int x = JOptionPane.showOptionDialog(null, "Click SEE MY FUTURE to see your future\n"
		+ "Click QUIT to quit the game",
        "FORTUNE TELLER!",
        JOptionPane.ERROR_MESSAGE,JOptionPane.DEFAULT_OPTION, null, options, options[0]);
		

//while pressed SEE MY FUTURE, show fortune and then repeat
			while(options[x]=="SEE MY FUTURE") {
				
				
					JOptionPane.showMessageDialog(null,list[randomfortune]);
					randomfortune = random.nextInt(list.length);
					
					 x = JOptionPane.showOptionDialog(null, "Click SEE MY FUTURE to see your future\n"
					+ "Click QUIT to quit the game",
					 "FORTUNE TELLER!",
...
//end of game			
JOptionPane.showMessageDialog(null, "This game is done");
System.exit(0);
